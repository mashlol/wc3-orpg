...
function CreateNeutralHostile()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("erat"), -29387.9, 29368.1, -11.370, FourCC("erat"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("erat"), -28317.8, 27564.7, -51.621, FourCC("erat"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("erat"), -28173.8, 28348.5, -6.560, FourCC("erat"))
    u = BlzCreateUnitWithSkin(p, FourCC("erat"), -28061.4, 28442.6, 269.000, FourCC("erat"))
    u = BlzCreateUnitWithSkin(p, FourCC("erat"), -28544.1, 29803.9, -52.563, FourCC("erat"))
    u = BlzCreateUnitWithSkin(p, FourCC("erat"), -28042.0, 30053.0, 269.401, FourCC("erat"))
    u = BlzCreateUnitWithSkin(p, FourCC("erat"), -28783.1, 31407.9, -87.095, FourCC("erat"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("erat"), -28865.8, 31277.9, -82.527, FourCC("erat"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ebru"), -25480.2, 29649.1, -25.789, FourCC("ebru"))
    u = BlzCreateUnitWithSkin(p, FourCC("ebru"), -25333.9, 29707.5, -48.101, FourCC("ebru"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("culn"), -25787.0, 29436.9, 9.031, FourCC("culn"))
    u = BlzCreateUnitWithSkin(p, FourCC("culn"), -25680.4, 29476.0, 327.666, FourCC("culn"))
end
