...
function CreateNeutralHostile()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h00A"), 3412.0, -2568.3, -55.706, FourCC("h00A"))
    u = BlzCreateUnitWithSkin(p, FourCC("h00A"), 3560.6, -2498.4, -72.342, FourCC("h00A"))
    u = BlzCreateUnitWithSkin(p, FourCC("h009"), 3393.8, -2848.6, 31.240, FourCC("h009"))
    u = BlzCreateUnitWithSkin(p, FourCC("h005"), 13451.9, -8052.1, -24.047, FourCC("h005"))
    u = BlzCreateUnitWithSkin(p, FourCC("h008"), 12726.2, -7704.6, -78.822, FourCC("h008"))
    u = BlzCreateUnitWithSkin(p, FourCC("h005"), 13515.6, -7969.5, -31.425, FourCC("h005"))
    u = BlzCreateUnitWithSkin(p, FourCC("h005"), 13870.0, -8007.6, 217.171, FourCC("h005"))
    u = BlzCreateUnitWithSkin(p, FourCC("h009"), 11902.9, -7642.0, -45.508, FourCC("h009"))
    u = BlzCreateUnitWithSkin(p, FourCC("h009"), 11988.2, -7555.5, -50.223, FourCC("h009"))
...
function CreateNeutralPassive()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n007"), 2949.4, -4842.7, 264.041, FourCC("n007"))
    SetUnitColor(u, ConvertPlayerColor(2))
    u = BlzCreateUnitWithSkin(p, FourCC("n008"), 3045.3, -4899.1, -40.499, FourCC("n008"))
    SetUnitColor(u, ConvertPlayerColor(2))
    u = BlzCreateUnitWithSkin(p, FourCC("n009"), 3299.3, -5269.9, 244.563, FourCC("n009"))
    SetUnitColor(u, ConvertPlayerColor(24))
    u = BlzCreateUnitWithSkin(p, FourCC("n003"), 2787.2, -4832.5, -86.622, FourCC("n003"))
    u = BlzCreateUnitWithSkin(p, FourCC("n00A"), 3023.5, -5249.7, 196.184, FourCC("n00A"))
    SetUnitColor(u, ConvertPlayerColor(24))
end
